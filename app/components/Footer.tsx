    ...
    <footer id="contact" className="py-10  px-6 border-t border-white/10">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex justify-center gap-6 mt-12">
          <Link
            href="https://www.instagram.com/hempeelzeraa/"
            target="_blank"
          ...
          <Link
            href="https://github.com/GabrielHempel1924"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="GitHub"
          ...
          <Link
            href="https://www.linkedin.com/in/gabriel-hempel/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="LinkedIn"
        ...
        <div className="text-center mt-12 pt-8 border-t border-white/10">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} Gabriel Hempel. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
