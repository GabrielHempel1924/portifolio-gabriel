...
export default function Banner(): React.JSX.Element {
  const texts = ["Software Engineer", "QA Analyst", "Web Developer"];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Gabriel Hempel</span>
                    </p>
                  </div>
              ...
              <Image
                src="/assets/me.png"
                alt="Gabriel Hempel - Software Engineer And QA Enginner"
                width={300}
                height={300}
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="">
              <p className="text-2xl"> Um site bonito </p>
              ...
              <p className="text-md text-white/80">
                Um código bem feito sustenta tudo o que vem depois.
              </p>
            </div>
          </div>
        </div>
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Atualmente, Eu sou Aprendiz na</span>
            <span className="flex items-center gap-2">
              <Image src="/assets/webhr.webp" alt="WebHR" width={20} height={20} className="w-5 h-5" style={{ width: "auto", height: "auto" }} />
              <span className="text-blue-400 font-semibold">Mitel,</span>
            </span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            Profissional autodidata da área de tecnologia, com experiência prática em qualidade de software
            e suporte a produtos digitais. Atuo na criação, validação e melhoria de soluções,
            sempre buscando o equilíbrio entre a experiência do usuário, a estabilidade do sistema e os objetivos do negócio.
            Tenho foco em qualidade, eficiência e aprendizado contínuo, contribuindo para produtos mais confiáveis e bem estruturados.
          </p>
